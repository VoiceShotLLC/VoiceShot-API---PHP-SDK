        ...
        <tr> 
          <td>
            <table width="100%" border="0" cellspacing="0" cellpadding="1" align="center" class="titletxt">
              <tr>
                <td height="35"><b>Text Summary</b></td>
                <td height="35" align="right"><b>Outbound text message example</b></td>
              </tr>
            </table>
          </td>
        </tr>
                        ...
                        <table width="90%" border="0" cellspacing="0" cellpadding="2" align="center" class="newbdytxt">
                          ...
                          <tr>
                            <td>
                                ...
                                <tr> 
                                  <td><iframe src="xmlsummaryoutsms.txt" name="IP" width="100%" height="300" frameborder="0"> 
                          ...
                          <tr> 
                            <td> 
                              <table width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="#C0C0C0">
                                <tr> 
                                  <td><iframe src="summaryoutsms.txt" name="IP" width="100%" height="300" frameborder="0"> 
                                    You must use a browser that supports the IFRAME 
                                    tag </iframe></td>
                                </tr>
                              </table>
